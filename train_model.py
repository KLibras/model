...
def process_videos_and_load_data():
    ...
    print(f"Total de vídeos a processar: {len(video_jobs)}")
            ...
            try:
                ...
                if result is not None:
                    ...
                    if processed_count % 10 == 0:
                        print(f"  Progresso: {processed_count}/{len(video_jobs)} vídeos processados")
                else:
                    failed_count += 1
    ...
    print(f"\n📊 Distribuição de amostras por ação:")
